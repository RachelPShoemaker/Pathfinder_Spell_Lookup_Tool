...
class TestScraper(unittest.TestCase):
    ...
    def test_scrape_actions(self):
        ...
        print(Data_Scraper_Draft_2.scrape_actions(self.soup_eat_fire))
        print(Data_Scraper_Draft_2.scrape_actions(self.soup_feather_fall))
        print(Data_Scraper_Draft_2.scrape_actions(self.soup_lose_path))
        ...
        print(Data_Scraper_Draft_2.scrape_actions(self.soup_time_sense))
        print(Data_Scraper_Draft_2.scrape_actions(self.soup_jump))
        print(Data_Scraper_Draft_2.scrape_actions(self.soup_deep_breath))
        ...
        print(Data_Scraper_Draft_2.scrape_actions(self.soup_choir))
        print(Data_Scraper_Draft_2.scrape_actions(self.soup_gravity_pull))
        print(Data_Scraper_Draft_2.scrape_actions(self.soup_harm))
        ...
        print(Data_Scraper_Draft_2.scrape_actions(self.soup_repulsion))
        print(Data_Scraper_Draft_2.scrape_actions(self.soup_frost_ray))
        print(Data_Scraper_Draft_2.scrape_actions(self.soup_know_dir))
        ...
        print(Data_Scraper_Draft_2.scrape_actions(self.soup_spirit_torrent))
        print(Data_Scraper_Draft_2.scrape_actions(self.soup_element_breath))
        print(Data_Scraper_Draft_2.scrape_actions(self.soup_chrom_armor))
        ...
        print(Data_Scraper_Draft_2.scrape_actions(self.soup_quick_sort))
        print(Data_Scraper_Draft_2.scrape_actions(self.soup_summon_instrument))
        print(Data_Scraper_Draft_2.scrape_actions(self.soup_animate_dead))
        ...
        print(Data_Scraper_Draft_2.scrape_actions(self.soup_raise_dead))
        print(Data_Scraper_Draft_2.scrape_actions(self.soup_alarm))
        print(Data_Scraper_Draft_2.scrape_actions(self.soup_bread_crumbs))
