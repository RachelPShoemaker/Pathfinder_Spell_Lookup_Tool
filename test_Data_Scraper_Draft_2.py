...
class TestScraper(unittest.TestCase):
    ...
    def test_scrape_traditions(self):
        # self.assertCountEqual(Data_Scraper_Draft_2.scrape_traditions(self.soup_acid_splash), "")
        # self.assertCountEqual(Data_Scraper_Draft_2.scrape_traditions(self.soup_alarm), "")
        # self.assertCountEqual(Data_Scraper_Draft_2.scrape_traditions(self.soup_animate_dead), "")
        # self.assertCountEqual(Data_Scraper_Draft_2.scrape_traditions(self.soup_ann_wave), "")
        # self.assertCountEqual(Data_Scraper_Draft_2.scrape_traditions(self.soup_bread_crumbs), "")
        # self.assertCountEqual(Data_Scraper_Draft_2.scrape_traditions(self.soup_chill_touch), "")
        # self.assertCountEqual(Data_Scraper_Draft_2.scrape_traditions(self.soup_choir), "")
        # self.assertCountEqual(Data_Scraper_Draft_2.scrape_traditions(self.soup_chrom_armor), "")
        # self.assertCountEqual(Data_Scraper_Draft_2.scrape_traditions(self.soup_chromatic_image), "")
        # self.assertCountEqual(Data_Scraper_Draft_2.scrape_traditions(self.soup_daze), "")
        # self.assertCountEqual(Data_Scraper_Draft_2.scrape_traditions(self.soup_deep_breath), "")
        # self.assertCountEqual(Data_Scraper_Draft_2.scrape_traditions(self.soup_dino_fort), "")
        # self.assertCountEqual(Data_Scraper_Draft_2.scrape_traditions(self.soup_eat_fire), "")
        # self.assertCountEqual(Data_Scraper_Draft_2.scrape_traditions(self.soup_element_breath), "")
        # self.assertCountEqual(Data_Scraper_Draft_2.scrape_traditions(self.soup_element_counter), "")
        # self.assertCountEqual(Data_Scraper_Draft_2.scrape_traditions(self.soup_exchange_image), "")
        # self.assertCountEqual(Data_Scraper_Draft_2.scrape_traditions(self.soup_feather_fall), "")
        # self.assertCountEqual(Data_Scraper_Draft_2.scrape_traditions(self.soup_fey_form), "")
        # self.assertCountEqual(Data_Scraper_Draft_2.scrape_traditions(self.soup_frost_ray), "")
        # self.assertCountEqual(Data_Scraper_Draft_2.scrape_traditions(self.soup_gift), "")
        # self.assertCountEqual(Data_Scraper_Draft_2.scrape_traditions(self.soup_gravity_pull), "")
        # self.assertCountEqual(Data_Scraper_Draft_2.scrape_traditions(self.soup_harm), "")
        # self.assertCountEqual(Data_Scraper_Draft_2.scrape_traditions(self.soup_holy_cascade), "")
    ...
    def test_scrape_cast_type(self):
        # self.assertCountEqual(Data_Scraper_Draft_2.scrape_cast_type(self.soup_acid_splash), "")
        # self.assertCountEqual(Data_Scraper_Draft_2.scrape_cast_type(self.soup_alarm), "")
        # self.assertCountEqual(Data_Scraper_Draft_2.scrape_cast_type(self.soup_animate_dead), "")
        # self.assertCountEqual(Data_Scraper_Draft_2.scrape_cast_type(self.soup_ann_wave), "")
        # self.assertCountEqual(Data_Scraper_Draft_2.scrape_cast_type(self.soup_bread_crumbs), "")
        # self.assertCountEqual(Data_Scraper_Draft_2.scrape_cast_type(self.soup_chill_touch), "")
        # self.assertCountEqual(Data_Scraper_Draft_2.scrape_cast_type(self.soup_choir), "")
        # self.assertCountEqual(Data_Scraper_Draft_2.scrape_cast_type(self.soup_chrom_armor), "")
        # self.assertCountEqual(Data_Scraper_Draft_2.scrape_cast_type(self.soup_chromatic_image), "")
        # self.assertCountEqual(Data_Scraper_Draft_2.scrape_cast_type(self.soup_daze), "")
        # self.assertCountEqual(Data_Scraper_Draft_2.scrape_cast_type(self.soup_deep_breath), "")
        # self.assertCountEqual(Data_Scraper_Draft_2.scrape_cast_type(self.soup_dino_fort), "")
        ...
        # self.assertCountEqual(Data_Scraper_Draft_2.scrape_cast_type(self.soup_exchange_image), "")
        # self.assertCountEqual(Data_Scraper_Draft_2.scrape_cast_type(self.soup_feather_fall), "")
        # self.assertCountEqual(Data_Scraper_Draft_2.scrape_cast_type(self.soup_fey_form), "")
        # self.assertCountEqual(Data_Scraper_Draft_2.scrape_cast_type(self.soup_frost_ray), "")
        # self.assertCountEqual(Data_Scraper_Draft_2.scrape_cast_type(self.soup_gift), "")
        ...
        # self.assertCountEqual(Data_Scraper_Draft_2.scrape_cast_type(self.soup_holy_cascade), "")
